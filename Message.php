...
<style> 
body{ 
background-image:lineargradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("back7.jpg"); 
height: 100vh;  
...
<div style="color: #cc66ff; font-family: 'Lucida Calligraphy', sansserif;font-size: 22px;"> 
...
<center>To Username : <input type="text" name="n" placeholder="Enter your Email id.."></center><br> 
