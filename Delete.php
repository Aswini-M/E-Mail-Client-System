...
<style> 
body{ 
background-image:lineargradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("back9.jpg"); 
height: 100vh; 
...
<div  style="color: #00e6e6; font-family: 'Lucida Calligraphy', sansserif;font-size: 22px;"> 
