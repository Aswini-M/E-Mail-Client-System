...
<style> 
body{ 
background-image:lineargradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("back1.jpg"); 
height: 100vh; 
...
<div style="color: #ffff66; font-family: 'Lucida Calligraphy', sansserif;font-size: 22px;"> 
...
<center>Mobile: <input type="Mobile" name="m" placeholder="Enter your Mobile.."></center><br> 
