...
<body> 
  <style> 
body{ 
  background-image:lineargradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("back5.jpg"); 
  height: 150vh;  
...
<div style="color: #66ffff; font-family: 'Lucida Calligraphy', sansserif;font-size: 22px;"> 
